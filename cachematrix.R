...
## cacheSolve(x, ...):
##  This function takes a list of setters and getters of the cache object
##  and returns the inverse of the cached matrix. If the cached inverse value
##  does not exist, it does calculate it and store in the cache.
